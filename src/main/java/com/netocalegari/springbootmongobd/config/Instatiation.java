...
import com.netocalegari.springbootmongobd.dto.AuthorDTO;
import com.netocalegari.springbootmongobd.dto.CommentDTO;
...
public class Instatiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO c1 = new CommentDTO("Aproveite", sdf.parse("21/03/2018"), new AuthorDTO(alex));
